    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="add-update-module" action="{{ route('admin.social.site.add.or.update') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Font Awesome icon (fa fa-facebook)" name="icon" required>
                        </div>
                    </div>
